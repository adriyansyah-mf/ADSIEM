  ...
  return (
    <div>
      ...
      <div style={{
        ...
        background: vuln_count > 0 ? 'rgba(255,68,68,0.07)' : 'rgba(46,212,122,0.06)',
...
function HostCard({ snap, onClick, selected }: { snap: HygieneSnapshot; onClick: () => void; selected: boolean }) {
  ...
  return (
    <div
      onClick={onClick}
      style={{
        background: 'var(--bg-panel)', border: `1px solid ${selected ? 'var(--accent-blue)' : 'var(--border)'}`,
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <PageHeader title="IT hygiene" subtitle="Host health and package vulnerability scan via osv.dev · auto-refresh 5 min" className="!mb-0" />
        {avgScore != null && (
